...
<form action="acoes.php?acao=editar" class="container card p-3 m-3" method="post">
  ...
  <div class="mb-3">
     ...
     <imput type="hiiden" name="id" value="<?php echo $usuario['id']?>">
  </div>
   <button class="btn btn-primary col-2">Atualizar</button>
